"use strict";(()=>{function l(t){try{window.pycmd(t)}catch(a){console.error("[Level] pycmd failed:",a)}}function i(){l("lua:summary")}function s(){l("lua:week_stats")}function n(){l("lua:month_stats")}function c(){l("lua:badges")}function d(){if(document.getElementById("lua-stats-panel"))return;let t=window.LUA_DATA||{level:1,totalXp:0,streak:0,totalCards:0},a=document.createElement("div");a.id="lua-stats-panel",a.className="lua-stats-panel",a.innerHTML=`
    ...
    `;let e=document.getElementById("lvlup-panel");e&&e.parentNode?e.parentNode.insertBefore(a,e.nextSibling):document.body.appendChild(a),i(),s(),n(),c()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",d):d();})();
